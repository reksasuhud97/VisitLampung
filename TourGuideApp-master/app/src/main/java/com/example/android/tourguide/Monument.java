...
public class Monument {
    ...
    public Monument (String monumentName, String monumentWebsite, String monumentShortDescription, //penentun tipe data
                     String monumentLongDescription, int monumentImage1ResourceId, int monumentImage2ResourceId) {
        mMonumentName = monumentName; //inisiasi per variabel data
    ...
    public String getMonumentName() { return mMonumentName; } //memanggil tiap variabel data yang memiliki nilai
    ...
    public String toString() {
        return "Monument: " + "mMonumentName= '" + mMonumentName + "', " + //penyusunan letak masing-masing variabel data
