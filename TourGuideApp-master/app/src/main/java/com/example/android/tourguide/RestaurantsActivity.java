...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurants); //set konten restaurant


        String[] restaurantsCousineArray = getResources().getStringArray(R.array.restaurants_cousine); //memanggil dan menyusun tiap variabel yang memiliki nilai
        ...
        for (int i=1; i<restaurantsName.size(); i++) { //perulangan secara increment
